...
# ╔═╡ ff35aa6b-6495-406d-8a44-67ef96e36704
using Plots, SymPy, Roots, ForwardDiff, LinearAlgebra, SpecialFunctions, QuadGK

# ╔═╡ 2bb032d7-d7ac-47d7-b202-60a765967fc3
using Printf, PlutoUI

# ╔═╡ c9f6d226-38d2-11ec-0b49-a9a2b5f0690d
md"""
This is a blank notebook. The packages and code used in the MTH229 projects are included in hidden cells at the bottom.
"""

# ╔═╡ 0308505b-68f5-44d4-8731-a4d510501e51


# ╔═╡ 1f6968bb-b055-4f76-81df-f971a0c9eb41


# ╔═╡ 7c9a1c1a-794f-49b8-ae53-0d744e1741f4


# ╔═╡ c56d6035-a595-4da8-8d3b-ea3264f5b538


# ╔═╡ 299111aa-2a02-4530-a652-adc171dca940
md"""
----
No moving parts below this line.

Use the cells to type in code and execute using "shift+enter" or clicking the "▶" button at the bottom right of a cell.

Pluto notebooks are idiosyncratic:
* They are reactive, meaning if you change the value assigned to a variable in one cell, all other cells referencing that value will be updated.
* This means variable names must be unique (you can't define `x`, say, with two values. Pluto will let you know if you try this.)
* You can redefine a variable as a value or a function (unlike typical Julia)
* Each "cell" can contain one expression. To bunch expressions together, use a `begin/end` block or a `let/end` block. The latter creates a new variable scope, like a function, allowing you to reuse variable names (the variables defined within a `let` block will not be reactive nor usable outside of the block.)
"""

# ╔═╡ 21a62079-6b48-4c3e-86e8-3cacae6556fb
